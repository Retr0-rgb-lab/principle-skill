...
### v1.2.0 (2026-07-11) — darwin 压力测试套件补全
- 完成 10/10 skills 的 `test-prompts.json`(共 156+ 条用例,darwin 兼容)
- 修复 debt-risk-triple-ratio 中 1 处 type/id 不一致 bug
- 完整覆盖表见 README.md "darwin 压力测试覆盖率"
...
- **[cycle-stage-detector/test-prompts.json](./cycle-stage-detector/test-prompts.json)** — 18 条 darwin 兼容测试用例(10 should_trigger + 6 should_not_trigger + 2 edge_case)
